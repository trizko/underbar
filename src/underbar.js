...
(function() {
  ...
  _.uniq = function(array) {
    ...
    _.each(array, function (item) {
      if (_.indexOf(uniq_array, item) === -1) {
        uniq_array.push(item);
      }
    });
  ...
  _.every = function(collection, iterator) {
    ...
    return _.reduce(collection, function(prev, item) {
      return prev && (iterator === undefined ? Boolean(item) : Boolean(iterator(item)));
    }, true);
  };
  ...
  _.memoize = function(func) {
    ...
    return function(arg1) {
      if (_.indexOf(alreadyCalled, arg1) === -1) {
        result = func.apply(this, arguments);
        alreadyCalled.push(arg1);
      }
      return result;
    };
  };
  ...
  _.shuffle = function(array) {
    ...
    _.each(array, function(){
      var random = shuffled.splice(Math.floor(Math.random() * (array.length - 1)), 1)
